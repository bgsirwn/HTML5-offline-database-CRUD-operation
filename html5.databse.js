    // Create database 
    var mywebdb = openDatabase('websql_db', '1.0', 'NS Blog WebSql Test DB', 2 * 1024 * 1024);
    ...
    function showSavedUserDetails()
    {
       ...
       mywebdb.transaction(function (tx) 
       {
              tx.executeSql('SELECT user_id, name, email FROM user_details', [], function (tx, results) 
              {
                   ...
                   {
                        show_data_append += '<tr style="border: 1px solid black;" ><td style="padding:8px;border: 1px solid black;" colspan="3"> No record found !</td></tr>';
                   }
